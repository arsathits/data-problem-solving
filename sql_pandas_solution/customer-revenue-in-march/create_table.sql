-- Create schema
CREATE SCHEMA IF NOT EXISTS "customer_revenue_in_march";

-- Create orders table
CREATE TABLE IF NOT EXISTS "customer_revenue_in_march".orders (
    id INT PRIMARY KEY,
    cust_id INT,
    order_date DATE,
...
-- Insert data
INSERT INTO "customer_revenue_in_march".orders (id, cust_id, order_date, order_details, total_order_cost) VALUES
